...
! function(t, e, i, n) {
    ...
    t.fn.simpleLightbox = function(n) {
            ...
            X = function() {
                ...
                A.on("touchstart.simplelb mousedown." + E, function(t) {
                    ...
                    if (h) {
                        h = !1;
                        var e = !0;
                        n.loop || (0 === D && o < 0 && (e = !1), D >= d.length - 1 && o > 0 && (e = !1)), Math.abs(o) > n.swipeTolerance && e ? j(o > 0 ? 1 : -1) : n.animationSlide && (g ? W(n.animationSpeed / 1e3, "0px") : A.animate({
                            left: u + "px"
                        }, n.animationSpeed / 2)), n.swipeClose && Math.abs(s) > 50 && Math.abs(o) < n.swipeTolerance && H()
                    }
                })
            },
            N = function() {
            ...
            K = function(n) {
                ...
                if ("hide" == n) {
                    ...
                    if (i.body.clientWidth < o) {
                        ...
                        l.className = "sl-scrollbar-measure", t("body").append(l), a = l.offsetWidth - l.clientWidth, t(i.body)[0].removeChild(l), t("body").data("padding", r), a > 0 && t("body").addClass("hidden-scroll").css({
                            "padding-right": r + a
                        })
                    }
        ...
        return n.close && T.appendTo(R), n.showCounter && d.length > 1 && (I.appendTo(R), I.find(".sl-total").text(d.length)), n.nav && k.appendTo(R), n.spinner && S.appendTo(R), d.on("click." + E, function(e) {
            if (O(this)) {
