...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <?php echo form_dropdown('DISTRICT_ID', $districts, $row->DISTRICT_ID, 'id="district_id" class="form-control" required'); ?>
    </div>
</div>
<div class="form-group caste_name_input">
    ...
    <div class="col-sm-6">
        <?php echo form_input(array('name' => 'THANA_ENAME', 'value' => $row->THANA_ENAME, "class" => "form-control caste_name", 'placeholder' => $this->lang->line('thana'))); ?>
    </div>
</div>
<div class="form-group">
...
<input type="hidden" name="THANA_ID" value="<?php $row->THANA_ID; ?>">
<div class="form-group">
