...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <?php echo form_dropdown('DIVISION_ID', $divisions, '', 'id="office_district" class="form-control select2"'); ?>
    </div>
</div>
<div class="form-group caste_name_input">
    ...
    <div class="col-sm-6">
        <?php echo form_input(array('name' => 'DISTRICT_ENAME', 'required' => 'required', "class" => "form-control caste_name", 'placeholder' => $this->lang->line('district_name'))); ?>
    </div>
</div>
<div class="form-group caste_name_input">
    ...
    <div class="col-sm-2">
        <?php echo form_input(array('name' => 'UD_DISTRICT_CODE', 'maxlength'=>'5',  "class" => "form-control caste_name", 'placeholder' => 'District Code')); ?>
    </div>
</div>
<div class="form-group">
