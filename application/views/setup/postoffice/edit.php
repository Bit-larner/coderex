...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <?php echo form_dropdown('', $divisions, $row->DIVISION_ID, 'onchange="divisionSelected(this.value)" id="division office_district" class="form-control" required'); ?>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <?php echo form_dropdown('ID_THANA', $thanas, $row->THANA_ID, 'id="thana_id" class="form-control" required'); ?>
    </div>
</div>
<div class="form-group caste_name_input">
    <label class="col-sm-3 control-label"><?php echo $this->lang->line('post_office');?></label>
    <a class="help-icon" data-container="body" data-toggle="popover" data-placement="right" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
        <i class="fa fa-question-circle"></i>
    </a>
    <div class="col-sm-6">
        <?php echo form_input(array('name' => 'POST_ENAME', 'value' => $row->POST_OFFICE_ENAME, "class" => "form-control caste_name", 'required placeholder' => 'Union Name')); ?>
    </div>
</div>
<div class="form-group caste_name_input">
    <label class="col-sm-3 control-label"><?php echo $this->lang->line('post_office_code');?></label>
    <a class="help-icon" data-container="body" data-toggle="popover" data-placement="right" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
        <i class="fa fa-question-circle"></i>
    </a>
    <div class="col-sm-6">
        <?php echo form_input(array('name' => 'POST_CODE', 'value' => $row->POST_CODE, "class" => "form-control caste_name", 'required placeholder' => 'Union Name')); ?>
    </div>
</div>
<div class="form-group">
...
<input type="hidden" name="THANA_ID" value="<?php $row->POST_OFFICE_ID; ?>">
<div class="form-group">
