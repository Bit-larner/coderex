...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <?php echo form_dropdown('DISTRICT_ID', '', '', 'onchange="districtSelected(this.value)" id="district_id" class="form-control" required'); ?>
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-6">
        <?php echo form_dropdown('THANA_ID', '', '', 'id="thana_id" class="form-control" required'); ?>
    </div>
</div>
<div class="form-group caste_name_input">
    <label class="col-sm-3 control-label"><?php echo $this->lang->line('post_office_name');?></label>
    <a class="help-icon" data-container="body" data-toggle="popover" data-placement="right" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
        <i class="fa fa-question-circle"></i>
    </a>
    <div class="col-sm-6">
        <?php echo form_input(array('name' => 'POST_ENAME', "class" => "form-control caste_name", 'required placeholder' => 'Post Office Name')); ?>
    </div>
</div>
<div class="form-group caste_name_input">
    ...
    <div class="col-sm-6">
        <?php echo form_input(array('name' => 'POST_CODE', "class" => "form-control caste_name", 'required placeholder' => 'Post Office Code')); ?>
    </div>
</div>
<div class="form-group">
