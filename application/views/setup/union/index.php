            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-11 col-sm-10 col-xs-8">
                        <h3 class="panel-title"><?php echo $this->lang->line('union_list');?></h3>
                    </div>
                    <div class="col-md-1 col-sm-2 col-xs-4">
                        <a type="button" href="<?php echo site_url('setup/union/create/'); ?>" class="btn btn-primary btn-xs modalLink"  title="<?php echo $this->lang->line('create_union');?>">
