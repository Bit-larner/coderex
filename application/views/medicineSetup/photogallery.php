                ...
                <div class="row">
                    ...
                    <div class="col-md-1 col-sm-2 col-xs-4">
                        <a type="button" class="modalLink btn btn-primary btn-xs"
                           title="Creat Photo Gallery"
                           href="<?php echo site_url("medicineSetup/createNewPhoto"); ?>">
                ...
                <table id="datatable" class="table table-striped table-bordered" width="100%" cellspacing="0">
                    ...
                    foreach ($photoGallery as $row) { ?>
                        <tr>
                            <td><?php echo $slNo++; ?></td>
                            <td>
                                <img class="center-block img-responsive" src="<?php echo base_url(); ?>/<?php echo $row->INSERTS_FILES; ?>" style="height:100px; width: 100px;" />
                            </td>
                            ...
                            <td>
                                <a class="btn btn-success btn-xs modalLink"
                                   href="<?php echo site_url("medicineSetup/viewPhotoGallery/$row->IMG_ID"); ?>"
                                   title="View Photo Gallery"><i
                                        class="glyphicon glyphicon-eye-open"></i></a>

                                <a class="btn btn-warning btn-xs modalLink"
                                   href="<?php echo site_url("medicineSetup/editPhotoGallery/$row->IMG_ID"); ?>"
                                   title="Edit Photo Gallery"><i
                                        class="glyphicon glyphicon-edit"></i></a>

                                <a href="<?php echo site_url("medicineSetup/deletePhotoGallery/$row->IMG_ID"); ?>"
