...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="file" class="btn btn-primary" id="INSERT_FILES" name="INSERT_FILES" value="">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-8">
        <textarea type="text" class="form-control" id="INSERT_FILES" name="SLIDER_DESC" id="SLIDER_DESC"
                  placeholder="please Enter Achivement Description" value=""><?php echo $hsdetails->SLIDER_DESC ?></textarea>
    </div>
</div>
