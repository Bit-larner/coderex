...
<div class="form-group">
    ...
    <div class="col-sm-8">
        <input type="text" class="form-control" id="SPECIAL_NAME" name="SPECIAL_NAME" required placeholder="please Enter Special Name" value="<?php echo $specialDepartment->SPECIAL_NAME ?>" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-8">
        <input type="text" class="form-control" id="SUB_TITTLE" name="SUB_TITTLE" required placeholder="please Enter Special Name" value="<?php echo $specialDepartment->SPECIAL_NAME ?>" />
    </div>
</div>
...
<div class="form-group">
    <label class="col-sm-3 control-label">Special Description</label>
    ...
    <div class="col-sm-8">
        ...
        <textarea  type="text" class="form-control" id="SPECIAL_DESC" name="SPECIAL_DESC"  placeholder="please Enter Category Description" value=""><?php echo $specialDepartment->SPECIAL_DESC ?></textarea>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="file" class="btn btn-primary" id="INSERT_FILES" name="INSERT_FILES">
    </div>
</div>
