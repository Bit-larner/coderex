...
<!-- form start -->
<?php echo form_open_multipart("", "id='amMainForm' class='form-horizontal' enctype='multipart/form-data'  autocomplete='off'"); ?>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="file" class="btn btn-primary" id="INSERTS_PDF" name="INSERTS_PDF">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-8">
        ...
        <textarea  type="text" class="form-control" id="ACHIVEMENT_DESC" name="ACHIVEMENT_DESC"  placeholder="please Enter Achivement Description" value=""><?php echo $achiventDetails->ACHIVEMENT_DESC ?></textarea>
    </div>
</div>
