...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="file" class="btn btn-primary" name="INSERTS_PDF">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-8">
        ...
        <textarea  type="text" class="form-control" name="ACHIVEMENT_DESC"  placeholder="please Enter Achivement Description" value=""></textarea>
    </div>
</div>
